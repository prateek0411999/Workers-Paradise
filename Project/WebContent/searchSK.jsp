...
%>
<br><br><br>
<h2 class="text-center"><%=skname%></h2>
<hr>
<br>
<%
String strskid,strskname,strskaddress,strskconno,skemailid;
int i=0,count=0;
...
try{
	con1=obj1.getDBconnection();
	    stmt1=con1.prepareStatement("select * from tblserviceseeker where skname=?");
	    stmt1.setString(1, skname);
